...
def preprocess(min_date:str = '2009-01-01', max_date:str = '2015-01-01') -> None:
    ...
    # pass  # YOUR CODE HERE
    cache_path = Path(LOCAL_DATA_PATH).joinpath("raw", f"query_{min_date}_{max_date}_{DATA_SIZE}.csv")
    ...
    processed_data = pd.DataFrame(np.concatenate((
    ...
    load_data_to_bq(processed_data, GCP_PROJECT, BQ_DATASET,table_name, False)
